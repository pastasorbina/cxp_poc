...
var modal_html = '<div class="modal hide fade wg_modal" ><div class="modal-header" style="min-height:20px;"><button class="close" data-dismiss="modal">×</button><h3 class="modal-title">&nbsp;</h3></div><div class="modal-body"><i class="icon-loading"></i></div><div class="modal-footer">&nbsp;</div></div>';

...
class Checkout extends MY_Controller {
	...
	function verify_checkout() {
		...
		//calculate total
		$grandtotal = (( $cart['cart_subtotal'] - $voucher_nominal ) + $shipping_price ) - $credit_amount ;
...
//----transaction start
		...
		$grandtotal = (( $cart_subtotal - $voucher_nominal ) + $shipping_price ) - $credit_amount ;
		$total_payout = $grandtotal + $unique;

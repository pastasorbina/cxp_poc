...
/****************** IDLES *********************/
	...
	function _set_rules() {
		...
		$this->form_validation->set_rules('c_sb_text_1', 'Sidebar Text 1', 'trim');
		$this->form_validation->set_rules('c_sb_text_2', 'Sidebar Text 1', 'trim');
		$this->form_validation->set_rules('c_sb_text_3', 'Sidebar Text 1', 'trim');
	...
	function _set_db() {
		...
		$this->db->set('c_sb_text_1' , $this->input->post('c_sb_text_1') );
		$this->db->set('c_sb_text_2' , $this->input->post('c_sb_text_2') );
		$this->db->set('c_sb_text_3' , $this->input->post('c_sb_text_3') );

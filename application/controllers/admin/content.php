...
class Content extends MY_Controller {
	...
	function index( $cl_id=0, $c_status="Active", $c_publish_status='All', $c_is_featured='All', $pagelimit=20, $offset=0, $orderby='c_date', $ascdesc='DESC', $encodedkey='' ) {
		...
		//if size_chart, redirect to list_size_chart
		if($content_label['cl_code'] == 'size_chart') {
			redirect(site_url()."admin/content/list_size_chart/");
		}
